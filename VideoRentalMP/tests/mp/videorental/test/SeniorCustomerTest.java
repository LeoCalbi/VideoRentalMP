...
public class SeniorCustomerTest {

	SeniorCustomer customer;
	
	@Before
	public void initFixture() {
		customer = new SeniorCustomer("Alessio", "Falai", LocalDate.of(1997, 10, 12), "Via caduti sul lavoro", "3347703001");
	}
	
	@Test
	public void testMakeCustomerCard() {
		assertTrue(customer.makeCustomerCard() instanceof SeniorCard);
	}
