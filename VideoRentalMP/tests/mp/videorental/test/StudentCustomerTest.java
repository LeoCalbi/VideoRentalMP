...
public class StudentCustomerTest {
	...
	public void initFixture() {
		customer = new StudentCustomer("000","Test", "Test", LocalDate.of(1990, 01, 01), "TestAddress", "000000000",new Credentials("test", "test"));
	}
	...
	public void testRestituitionEmptyList() throws EmptyRentListException, AbsentRentException, NotRentedException {
		customer.restitution(new DVD(new Movie("Titolo", new Director("Leonardo", "Calbi"), new Genre("Action"), LocalDate.of(2010, 5, 10)), 3.0));
	}
