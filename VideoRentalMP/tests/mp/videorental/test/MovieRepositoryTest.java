...
public class MovieRepositoryTest {
	...
	private static Movie movie1 = new Movie("Title1", new Director("Test", "Test"), new Genre("Test"), LocalDate.of(2000, 10, 11));
	private static Movie movie2 = new Movie("Title2", new Director("Test", "Test"), new Genre("Test"), LocalDate.of(2000, 10, 11));
